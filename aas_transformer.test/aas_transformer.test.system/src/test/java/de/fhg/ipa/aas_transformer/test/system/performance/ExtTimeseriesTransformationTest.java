...
@Disabled
public class ExtTimeseriesTransformationTest extends ExtAbstractPerformanceTest implements Runnable {
    private static final int PARALLEL_SUBMODEL_CREATOR_COUNT = 2;
    private static final int SOURCE_SUBMODEL_COUNT = 100;
    private static final List<Integer> EXECUTOR_COUNTS = List.of(1,3,5,10);
    private static final int TEST_COUNT_PER_EXECUTOR_COUNT = 3;
    private static final String FILE_PREFIX = "ExtTimeseriesTransformationTest_";
    ...
    private void scaleExecutor(int desiredCount) {
        ...
        if(deltaTaskCount != 0) {
            ...
            System.out.println("Executor already at desired count");
        }
    }
    ...
    public void testImpactOfExecutorCountOnTransformationSpeed(int count) throws DeserializationException {
        ...
        } while (smCount < smCountInitial * 2);
