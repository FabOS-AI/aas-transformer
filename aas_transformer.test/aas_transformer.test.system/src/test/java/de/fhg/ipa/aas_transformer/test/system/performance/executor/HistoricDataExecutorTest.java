...
public class HistoricDataExecutorTest extends AbstractExecutorTest {
    protected HistoricDataExecutorTest() {
        super(HistoricDataExecutorTest.class);
    }
    ...
    public void testHistoricDataCreator(int executorCount) throws InterruptedException {
        // Scale Executor:
        ...
        List<HistoricDataJobCreator> smCreatorThreads = new ArrayList<>();
        for(int i = 0; i < submodelCreatorCount; i++)
            smCreatorThreads.add(getHistoricDataJobCreator(0, 1));
